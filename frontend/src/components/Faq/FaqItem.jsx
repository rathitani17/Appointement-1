  ...
  return (
    <div className="p-3 lg:p-5 rounded-[12px] border border-solid border-[#D9DCE2] mb-5 cursor-pointer">
      ...
      >
        ...
        <div
        className={'${isOpen && "bg-primaryColor text-white border-none"} w-7 h-7 lg:w-8 lg:h-8  rounded flex items-center justify-center border
         border-solid border-[#141F21] '}
         >
  ...
  return (
    <div className="p-3 lg:p-5 rounded-[12px] border border-solid border-[#D9DCE2] mb-5 cursor-pointer" onClick={toggleAccordion}>
      <div className="flex items-center justify-between gap-5">
        ...
        <div className={`w-7 h-7 lg:w-8 lg:h-8 rounded flex items-center justify-center border border-solid border-[#141F21] ${isOpen ? 'bg-primaryColor text-white border-none' : ''}`}>
          {isOpen ? <AiOutlineMinus /> : <AiOutlinePlus />}
        </div>
      </div>
