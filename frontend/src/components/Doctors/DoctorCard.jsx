...
const DoctorCard = ({doctor}) => {
  ...
  return (
    ...
    <div 
    className='mt-2 lg:mt flex items-center justify-between'>
    ...
    <h3 className='text-[16px] leading-7 lg:text-[18px] lg:leading-[30px] font-semibold text-headingColor'>
        ...
        <Link
                to="/doctors"
                className="w-[44px] h-[44px]  rounded-full border border-solid border-[#181A1E]  flex items-center group hover: bg-primaryColor
                hover:border-none"
              >
